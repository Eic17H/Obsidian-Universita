...
Se c'è una [[Classi e oggetti|classe]] che devi usare solo una volta, è scomodo dover fare un intero file per questa classe. Se di queste classe a utilizzo singolo ce ne sono 500, sono tanti file, e usare GitHub diventa lentissimo. Quindi usiamo le *classi anonime*, cioè creiamo una classe a cui non diamo un nome, e contemporaneamente istanziamo un singolo oggetto di quella classe, e subito dopo la classe smette di esistere. Una dichiarazione di classe anonima conta come una riga, quindi alla fine ci va il punto e virgola.
