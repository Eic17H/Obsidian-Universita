...
cssclasses: pr2
---
Le lambda sono un modo di Java per cercare di modernizzarsi poco poco con la [[Programmazione funzionale|programmazione funzionale]]. Ok bellissimi gli oggetti quanto vuoi ma ogni tanto sono un po' pesanti. Ci sono momenti in cui fa comodo tornare al C, e definire comportamenti che ci servono solo una volta, un po' come le classi anonime. Le Java Lambda sono piuttosto snelle, stanno spesso in una riga: `(argomenti) -> {corpo}`.
