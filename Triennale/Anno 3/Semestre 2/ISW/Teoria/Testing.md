...
#### Integration
Si testano le interazioni tra più componenti: comunicazione, scambio di informazioni. Di solito si trovano errori nelle <span class="pr2">[[Triennale/Anno 2/Semestre 2/PR2/Teoria/Interfacce|interfacce]]</span>, per esempio sbagliando l'ordine dei parametri. Può essere sua white box che black box.
#### Functional
