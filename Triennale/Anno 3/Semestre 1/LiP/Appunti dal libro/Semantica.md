...
Una computazione, in generale, è una catena di cambiamenti (cambiamenti di stato o di valori). Questi cambiamenti sono descritti da [[Regole di inferenza|regole di inferenza]], della forma $\dfrac{\text{premessa}}{\text{conseguenza}}$.
