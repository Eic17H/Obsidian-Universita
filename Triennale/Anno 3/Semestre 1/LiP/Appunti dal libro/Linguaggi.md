...
cssclasses:
  - lip
---
Lo stesso argomento: <span class="logica">[[Linguaggio formale|Logica]]</span>, <span class="alf">[[Triennale/Anno 2/Semestre 1/ALF/File/Linguaggi formali|ALF]]</span>, <span class="pr2">[[Triennale/Anno 2/Semestre 2/PR2/Teoria/Linguaggio|PR2]]</span>
## Lettura
...
Sia $A$ un insieme finito, che chiamiamo alfabeto. $A^*$ è l'insieme di tutte le stringhe di lunghezza finita formate dagli elementi di $A$. Se $A=\{a,b\}$, allora $a \in A^*$, e anche $abbabbabbaaabab \in A^*$. Diciamo che sono parole.

> **Parola vuota**: Indichiamo con $ε$ la parola vuota, cioè la parola che non contiene simboli. $ε \in A^* \; \forall A$.
...
> **Infisso**: siano $w, w' \in A^*$, $w'$ è infisso di $w$ se esistono $w'', w''' \in A^*$ tali che $w = w'' \cdot w' \cdot w'''$.
