...
cssclasses:
  - lip
---
Questa variante assume che stiamo lavorando in OCaml o "in un linguaggio OCaml-like", quindi non vengono fornite regole di tipizzazione e semplicemente bisogna scrivere un termine con un determinato tipo.

## Teoria

* <span class="alf">[[Triennale/Anno 2/Semestre 1/ALF/OCaml/Funzioni|OCaml]]</span>
