...
$PROJ_{NomeProdotto}(SEL_{Prezzo<10} PRODOTTO)$

Elencare i numeri civici dei magazzini di via Ripamonti a Milano

$PROJ_{NumeroCivico} (SEL _{Città="Milano"\land Via="Ripamonti"} MAGAZZINO)$
...
DISTINCT non funziona su Postgres, su MySQL sì. Per replicarlo su PG usi una subquery
