...
cssclasses:
  - logica
---
Lo stesso argomento: <span class="lip">[[Triennale/Anno 3/Semestre 1/LiP/Appunti dal libro/Linguaggi|LiP]]</span>, <span class="alf">[[Triennale/Anno 2/Semestre 1/ALF/File/Linguaggi formali|ALF]]</span>, <span class="pr2">[[Triennale/Anno 2/Semestre 2/PR2/Teoria/Linguaggio|PR2]]</span>
...
<span class="am">[[Dimostrazioni|Definizione induttiva]]</span>: parto da base e passo. Analisi Matematica menzionata. Episodio crossover, e ovviamente regole di inferenza di ALF. Parto da uno stock iniziale di elementi dell'insieme, che è la base, e definisco nel passo una funzione che mi espande a macchia d'olio l'insieme generando nuovi elementi.
