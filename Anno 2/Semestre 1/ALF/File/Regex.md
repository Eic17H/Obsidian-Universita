...
cssclasses:
  - alf
---
Lo stesso argomento: <span class="lip">[[Espressioni regolari|LiP]]</span>, <span class="so">[[Anno 2/Semestre 1/SO/Lab v1/Regex|SO]]</span>

Abbiamo visto gli [[Anno 2/Semestre 1/ALF/File/Automi|automi a stati finiti]]. Non possono fare tante cose, per esempio i palindromi. Si usano per l'analisi lessicale nei compilatori.
...
> **Linguaggio vuoto**, che non contiene nessuna parola
>$\emptyset$
...
> $\mathcal{L}(EE') = \mathcal{L}(E)\mathcal{L}(E')$, dove $LL' = \{w w'\;|\; w\in L, w'\in L'\}$
