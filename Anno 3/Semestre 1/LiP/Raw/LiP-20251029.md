...
Nel nostro linguaggio, diciamo di avere scope dinamico:
...
Quindi per i numeri, che sono costantti, $\langle n,st\rangle\rightarrow n$, invece per le variabili $\langle x,st\rangle\rightarrow st(x)$. E me ne vado, leggerò il libro.