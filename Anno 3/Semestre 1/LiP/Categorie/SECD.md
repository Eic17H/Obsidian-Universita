...
Visto il concetto di <span class="asd">[[Anno 1/Semestre 2/ASD/New/Stack|stack/pila]]</span>, useremo sia la notazione intuitiva $\underset{\underset C B} A$, sia la notazione corretta $A::B::C$.$\newcommand{\llangle}{⟪}\newcommand{\rrangle}{⟫}$
