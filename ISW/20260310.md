...
In Cina stanno già lavorando ai robot, probabilmente entro fine anno ci siamo. Avranno intelligenza on-board o dovranno comunicare con un server? Vediamo. Probabilmente dipenderà dallo scopo del robot.